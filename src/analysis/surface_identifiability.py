#!/usr/bin/env python3
"""
surface_identifiability.py - is a_xx redundant? Show scale and shape are SEPARATE, IDENTIFIED objects.
...
Run: python3 surface_identifiability.py
"""
...
def main():
    ...
    df.to_csv(DIAG_DIR / "tables" / "sde_identifiability_summary.csv", index=False)
