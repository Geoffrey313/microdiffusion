#!/usr/bin/env python3
"""
forecast_two_part.py - the two-part zero/nonzero model, on the paper's 60/40 split.
...
Key question: does imbalance survive in the OCCURRENCE part (whether the price moves)
even though the nested ladder demoted it in the magnitude part (how much it moves)?
