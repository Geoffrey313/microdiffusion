#!/usr/bin/env python3
"""
garch_compare.py - is the book-state diffusion a_xx INCREMENTAL to GARCH?
...
def main():
    ...
    df.to_csv(DIAG_DIR / "tables" / "sde_garch_compare.csv", index=False)
