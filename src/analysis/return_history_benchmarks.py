#!/usr/bin/env python3
"""
return_history_benchmarks.py - stronger return-history benchmarks.

Two standard benchmarks the predictive-density grid omitted:
...
Run: python3 return_history_benchmarks.py
"""
