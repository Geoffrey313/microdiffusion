#!/usr/bin/env python3
"""
event_panel.py - build the flat event panel used by the forecast analyses.
...
Conventions reproduce the paper's headline scripts EXACTLY (gap_figures.py):
...
def main():
    ...
    (OUT / "garch_spec.txt").write_text(
        "GARCH(1,1) benchmarks (garch_compare.py / return_history_benchmarks.py / garch_grid.py):\n"
