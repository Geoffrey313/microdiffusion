#!/usr/bin/env python3
"""
innovation_loio.py - robustness of the INNOVATION LAW (not just the surface).

Concern addressed: the GH is fitted to residuals pooled across 40 instruments of very
