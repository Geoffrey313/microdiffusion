#!/usr/bin/env python3
"""
surface_prototype.py - does the state-dependent diffusion model reproduce the conditional move
...
Run: python3 surface_prototype.py
"""
...
def main():
    ...
    pd.DataFrame([summ]).to_csv(DIAG_DIR / "tables" / "sde_prototype_summary.csv", index=False)
