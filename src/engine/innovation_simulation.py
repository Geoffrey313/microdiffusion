#!/usr/bin/env python3
"""
innovation_simulation.py - (1) fold the Generalized-Hyperbolic kick into the SDE simulation and redraw the
...
Run: python3 innovation_simulation.py
"""
...
def main():
    ...
    pd.DataFrame({"k": ks, "data": emp, "GH_sim": t_gh, "Gaussian_sim": t_n, "N01": t_norm}).to_csv(
        DIAG_DIR / "tables" / "sde_ghsim_summary.csv", index=False)
