#!/usr/bin/env python3
"""
innovation_heavytail.py - replace the Gaussian innovation in the conditional SDE with a
...
Run: python3 innovation_heavytail.py
"""
...
def main():
    ...
    out_t = DIAG_DIR / "tables" / "sde_heavytail_summary.csv"
