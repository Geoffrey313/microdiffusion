...
def figure_surface(states, n_I, m_S, plt):
    ...
    fig.suptitle(T(r"The diffusion surface on the United States large-cap panel and its walk-forward transfer"), y=1.0)
...
def figure_heavytail(states, n_I, m_S, plt):
    ...
    fig.suptitle(T("Heavy-tailed innovation on the United States large-cap panel: standardised held-out "
